...
\PY{k}{def} \PY{n+nf}{imshow\PYZus{}plots}\PY{p}{(}\PY{n}{img\PYZus{}path}\PY{p}{,} \PY{n}{figsize}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{30}\PY{p}{,} \PY{l+m+mi}{25}\PY{p}{)}\PY{p}{)}\PY{p}{:}
\PY{+w}{    }\PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
\PY{l+s+sd}{    Muestra una imagen en un gráfico con un tamaño específico.}

\PY{l+s+sd}{    Parámetros:}
\PY{l+s+sd}{    img\PYZus{}path (str): La ruta del archivo de la imagen a mostrar.}
\PY{l+s+sd}{    figsize (tuple): El tamaño de la figura en pulgadas (ancho, alto).}
\PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
    \PY{n}{fig} \PY{o}{=} \PY{n}{plt}\PY{o}{.}\PY{n}{figure}\PY{p}{(}\PY{n}{figsize}\PY{o}{=}\PY{n}{figsize}\PY{p}{)}
    \PY{n}{img} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{asarray}\PY{p}{(}\PY{n}{Image}\PY{o}{.}\PY{n}{open}\PY{p}{(}\PY{n}{img\PYZus{}path}\PY{p}{)}\PY{p}{)}
    \PY{n}{plt}\PY{o}{.}\PY{n}{imshow}\PY{p}{(}\PY{n}{img}\PY{p}{)}
    \PY{n}{plt}\PY{o}{.}\PY{n}{axis}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{off}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
    \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}


\PY{k}{def} \PY{n+nf}{fig\PYZus{}plots}\PY{p}{(}
    \PY{n}{x}\PY{p}{,}
    \PY{n}{y}\PY{p}{,}
    \PY{n}{pplt}\PY{p}{,}
    \PY{n}{color}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{blue}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,}
    \PY{n}{nejex}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Eje x}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,}
    \PY{n}{nejey}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Eje y}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,}
    \PY{n}{titulo}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Titulo}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,}
    \PY{n}{labelsize}\PY{o}{=}\PY{l+m+mi}{20}\PY{p}{,}
...
\PY{l+s+sd}{    figsize (tuple): El tamaño de la figura en pulgadas (ancho, alto).}
\PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
    \PY{n}{pplt}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{x}\PY{p}{,} \PY{n}{y}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{\PYZhy{}}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{color}\PY{o}{=}\PY{n}{color}\PY{p}{)}
    \PY{n}{pplt}\PY{o}{.}\PY{n}{tick\PYZus{}params}\PY{p}{(}\PY{n}{labelsize}\PY{o}{=}\PY{n}{labelsize} \PY{o}{*} \PY{l+m+mf}{0.8}\PY{p}{)}
    \PY{n}{pplt}\PY{o}{.}\PY{n}{tick\PYZus{}params}\PY{p}{(}\PY{n}{labelsize}\PY{o}{=}\PY{n}{labelsize} \PY{o}{*} \PY{l+m+mf}{0.8}\PY{p}{)}
    \PY{n}{pplt}\PY{o}{.}\PY{n}{xlabel}\PY{p}{(}\PY{n}{nejex}\PY{p}{,} \PY{n}{labelpad}\PY{o}{=}\PY{l+m+mi}{20}\PY{p}{,} \PY{n}{fontsize}\PY{o}{=}\PY{n}{labelsize}\PY{p}{)}
    \PY{n}{pplt}\PY{o}{.}\PY{n}{ylabel}\PY{p}{(}\PY{n}{nejey}\PY{p}{,} \PY{n}{labelpad}\PY{o}{=}\PY{l+m+mi}{20}\PY{p}{,} \PY{n}{fontsize}\PY{o}{=}\PY{n}{labelsize}\PY{p}{)}
    \PY{n}{pplt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{n}{titulo}\PY{p}{,} \PY{n}{fontsize}\PY{o}{=}\PY{n}{fontsize}\PY{p}{)}


\PY{k}{def} \PY{n+nf}{datos\PYZus{}plots}\PY{p}{(}
    \PY{n}{o}\PY{p}{,}
    \PY{n}{matriz\PYZus{}dataframe}\PY{p}{,}
    \PY{n}{nNbins}\PY{p}{,}
    \PY{n}{densidad}\PY{p}{,}
    \PY{n}{eje\PYZus{}x}\PY{o}{=}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Eje x}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Eje x}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{,}
    \PY{n}{eje\PYZus{}y}\PY{o}{=}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Eje y}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Eje y}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{,}
    \PY{n}{titulo}\PY{o}{=}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Titulo}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Titulo}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{,}
    \PY{n}{labelsize}\PY{o}{=}\PY{l+m+mi}{20}\PY{p}{,}
    \PY{n}{fontsize}\PY{o}{=}\PY{l+m+mi}{20}\PY{p}{,}
    \PY{n}{figsize}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{30}\PY{p}{,} \PY{l+m+mi}{10}\PY{p}{)}\PY{p}{,}
...
\PY{l+s+sd}{    figsize (tuple): El tamaño de la figura en pulgadas (ancho, alto).}
\PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
    \PY{n}{matriz\PYZus{}data\PYZus{}frame} \PY{o}{=} \PY{p}{[}\PY{n}{u} \PY{k}{for} \PY{n}{u} \PY{o+ow}{in} \PY{n}{matriz\PYZus{}dataframe} \PY{k}{if} \PY{n}{u}\PY{p}{]}
    \PY{n}{nbins} \PY{o}{=} \PY{p}{[}\PY{n}{u} \PY{k}{for} \PY{n}{u} \PY{o+ow}{in} \PY{n}{nNbins} \PY{k}{if} \PY{n}{u}\PY{p}{]}
    \PY{n}{figura}\PY{p}{,} \PY{n}{ax} \PY{o}{=} \PY{n}{plt}\PY{o}{.}\PY{n}{subplots}\PY{p}{(}\PY{n}{nrows}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{,} \PY{n}{ncols}\PY{o}{=}\PY{l+m+mi}{2}\PY{p}{,} \PY{n}{figsize}\PY{o}{=}\PY{n}{figsize}\PY{p}{)}
    \PY{k}{for} \PY{n}{u}\PY{p}{,} \PY{n}{lista\PYZus{}dataframe} \PY{o+ow}{in} \PY{n+nb}{enumerate}\PY{p}{(}\PY{n}{matriz\PYZus{}data\PYZus{}frame}\PY{p}{)}\PY{p}{:}
        \PY{k}{for} \PY{n}{df} \PY{o+ow}{in} \PY{n}{lista\PYZus{}dataframe}\PY{p}{:}
            \PY{n}{df}\PY{p}{[}\PY{n}{densidad}\PY{p}{]}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{style}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{.}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{ax}\PY{o}{=}\PY{n}{ax}\PY{p}{[}\PY{n}{u}\PY{p}{]}\PY{p}{)}
            \PY{n}{ax}\PY{p}{[}\PY{n}{u}\PY{p}{]}\PY{o}{.}\PY{n}{tick\PYZus{}params}\PY{p}{(}\PY{n}{labelsize}\PY{o}{=}\PY{n}{labelsize} \PY{o}{*} \PY{l+m+mf}{0.9}\PY{p}{)}
            \PY{n}{ax}\PY{p}{[}\PY{n}{u}\PY{p}{]}\PY{o}{.}\PY{n}{tick\PYZus{}params}\PY{p}{(}\PY{n}{labelsize}\PY{o}{=}\PY{n}{labelsize} \PY{o}{*} \PY{l+m+mf}{0.9}\PY{p}{)}
            \PY{n}{ax}\PY{p}{[}\PY{n}{u}\PY{p}{]}\PY{o}{.}\PY{n}{set\PYZus{}xlabel}\PY{p}{(}\PY{n}{eje\PYZus{}x}\PY{p}{[}\PY{n}{u}\PY{p}{]}\PY{p}{,} \PY{n}{labelpad}\PY{o}{=}\PY{l+m+mi}{20}\PY{p}{,} \PY{n}{fontsize}\PY{o}{=}\PY{n}{labelsize}\PY{p}{)}
            \PY{n}{ax}\PY{p}{[}\PY{n}{u}\PY{p}{]}\PY{o}{.}\PY{n}{set\PYZus{}ylabel}\PY{p}{(}\PY{n}{eje\PYZus{}y}\PY{p}{[}\PY{n}{u}\PY{p}{]}\PY{p}{,} \PY{n}{labelpad}\PY{o}{=}\PY{l+m+mi}{20}\PY{p}{,} \PY{n}{fontsize}\PY{o}{=}\PY{n}{labelsize}\PY{p}{)}
            \PY{n}{ax}\PY{p}{[}\PY{n}{u}\PY{p}{]}\PY{o}{.}\PY{n}{set\PYZus{}title}\PY{p}{(}\PY{n}{titulo}\PY{p}{[}\PY{n}{u}\PY{p}{]}\PY{p}{,} \PY{n}{pad}\PY{o}{=}\PY{l+m+mi}{25}\PY{p}{,} \PY{n}{fontsize}\PY{o}{=}\PY{n}{fontsize}\PY{p}{)}

    \PY{n}{figura}\PY{o}{.}\PY{n}{tight\PYZus{}layout}\PY{p}{(}\PY{p}{)}
    \PY{n}{plt}\PY{o}{.}\PY{n}{subplots\PYZus{}adjust}\PY{p}{(}\PY{n}{wspace}\PY{o}{=}\PY{n}{wspace}\PY{p}{)}
    \PY{n}{figura}\PY{o}{.}\PY{n}{savefig}\PY{p}{(}\PY{l+s+sa}{f}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{plots/dispers}\PY{l+s+si}{\PYZob{}}\PY{n}{o}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s2}{.png}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{bbox\PYZus{}inches}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{tight}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}


\PY{k}{def} \PY{n+nf}{figure\PYZus{}plots}\PY{p}{(}
    \PY{n}{o}\PY{p}{,}
    \PY{n}{matriz\PYZus{}dataframe}\PY{p}{,}
    \PY{n}{nNbins}\PY{p}{,}
    \PY{n}{densidad}\PY{p}{,}
...
\PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
    ...
    \PY{k}{for} \PY{n}{u}\PY{p}{,} \PY{n}{lista\PYZus{}dataframe} \PY{o+ow}{in} \PY{n+nb}{enumerate}\PY{p}{(}\PY{n}{matriz\PYZus{}data\PYZus{}frame}\PY{p}{)}\PY{p}{:}
        \PY{k}{for} \PY{n}{df} \PY{o+ow}{in} \PY{n}{lista\PYZus{}dataframe}\PY{p}{:}
            \PY{n}{df}\PY{p}{[}\PY{n}{densidad}\PY{p}{]}\PY{o}{.}\PY{n}{hist}\PY{p}{(}
                \PY{n}{bins}\PY{o}{=}\PY{n}{nbins}\PY{p}{[}\PY{n}{u}\PY{p}{]}\PY{p}{,}
                \PY{n}{ax}\PY{o}{=}\PY{n}{ax}\PY{p}{[}\PY{n}{u}\PY{p}{]}\PY{p}{,}
                \PY{n}{density}\PY{o}{=}\PY{k+kc}{True}\PY{p}{,}
                \PY{n}{grid}\PY{o}{=}\PY{k+kc}{False}\PY{p}{,}
                \PY{n}{histtype}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{step}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,}
                \PY{n}{linewidth}\PY{o}{=}\PY{l+m+mi}{3}\PY{p}{,}
            \PY{p}{)}
            \PY{c+c1}{\PYZsh{} frm = r\PYZsq{}\PYZdl{}\PYZob{}:.0f\PYZcb{}\PYZdl{}\PYZsq{}}
            \PY{c+c1}{\PYZsh{} xlist = np.linspace(np.min(df[densidad]), np.max(df[densidad]), 6)}
            \PY{c+c1}{\PYZsh{} ax[u].xaxis.set\PYZus{}major\PYZus{}locator(mticker.FixedLocator(xlist))}
            \PY{c+c1}{\PYZsh{} ax[u].set\PYZus{}xticklabels([frm.format(x) for x in xlist],fontsize=14)}
            \PY{n}{ax}\PY{p}{[}\PY{n}{u}\PY{p}{]}\PY{o}{.}\PY{n}{tick\PYZus{}params}\PY{p}{(}\PY{n}{labelsize}\PY{o}{=}\PY{n}{labelsize} \PY{o}{*} \PY{l+m+mf}{0.9}\PY{p}{)}
            \PY{n}{ax}\PY{p}{[}\PY{n}{u}\PY{p}{]}\PY{o}{.}\PY{n}{tick\PYZus{}params}\PY{p}{(}\PY{n}{labelsize}\PY{o}{=}\PY{n}{labelsize} \PY{o}{*} \PY{l+m+mf}{0.9}\PY{p}{)}
            \PY{n}{ax}\PY{p}{[}\PY{n}{u}\PY{p}{]}\PY{o}{.}\PY{n}{set\PYZus{}xlabel}\PY{p}{(}\PY{n}{eje\PYZus{}x}\PY{p}{[}\PY{n}{u}\PY{p}{]}\PY{p}{,} \PY{n}{labelpad}\PY{o}{=}\PY{l+m+mi}{20}\PY{p}{,} \PY{n}{fontsize}\PY{o}{=}\PY{n}{labelsize}\PY{p}{)}
            \PY{n}{ax}\PY{p}{[}\PY{n}{u}\PY{p}{]}\PY{o}{.}\PY{n}{set\PYZus{}ylabel}\PY{p}{(}\PY{n}{eje\PYZus{}y}\PY{p}{[}\PY{n}{u}\PY{p}{]}\PY{p}{,} \PY{n}{labelpad}\PY{o}{=}\PY{l+m+mi}{20}\PY{p}{,} \PY{n}{fontsize}\PY{o}{=}\PY{n}{labelsize}\PY{p}{)}
            \PY{n}{ax}\PY{p}{[}\PY{n}{u}\PY{p}{]}\PY{o}{.}\PY{n}{set\PYZus{}title}\PY{p}{(}\PY{n}{titulo}\PY{p}{[}\PY{n}{u}\PY{p}{]}\PY{p}{,} \PY{n}{pad}\PY{o}{=}\PY{l+m+mi}{25}\PY{p}{,} \PY{n}{fontsize}\PY{o}{=}\PY{n}{fontsize}\PY{p}{)}
            \PY{c+c1}{\PYZsh{} ax[u].yaxis.set\PYZus{}data\PYZus{}interval(0, 0.065 ,True)}

    \PY{n}{figura}\PY{o}{.}\PY{n}{tight\PYZus{}layout}\PY{p}{(}\PY{p}{)}
    \PY{n}{plt}\PY{o}{.}\PY{n}{subplots\PYZus{}adjust}\PY{p}{(}\PY{n}{wspace}\PY{o}{=}\PY{n}{wspace}\PY{p}{)}
    \PY{n}{figura}\PY{o}{.}\PY{n}{savefig}\PY{p}{(}\PY{l+s+sa}{f}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{plots/Graf}\PY{l+s+si}{\PYZob{}}\PY{n}{o}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s2}{.png}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{bbox\PYZus{}inches}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{tight}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}


\PY{k}{def} \PY{n+nf}{bulk\PYZus{}data\PYZus{}grouping}\PY{p}{(}\PY{n}{conjunto\PYZus{}de\PYZus{}datos}\PY{p}{,} \PY{n}{agrupando\PYZus{}chunk}\PY{p}{,} \PY{n}{directorio\PYZus{}save}\PY{p}{)}\PY{p}{:}
\PY{+w}{    }\PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
\PY{l+s+sd}{    Esta función agrupa y guarda  conjunto masivos  de datos}

\PY{l+s+sd}{    conjunto\PYZus{}de\PYZus{}datos: conjuntos de datos pd.read\PYZus{}csv(...)}

\PY{l+s+sd}{    agrupando\PYZus{}chunk: variable que contiene el nombre de una columna dataframe}
\PY{l+s+sd}{      con la que quieres agrupar el conjunto masivo de datos.}

\PY{l+s+sd}{    directorio\PYZus{}save: esta varialbe debe contener la direccion}
\PY{l+s+sd}{    donde vas a gurdar los datos agrupados.}

\PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
    \PY{n}{grupos\PYZus{}acumulados} \PY{o}{=} \PY{p}{\PYZob{}}\PY{p}{\PYZcb{}}
    \PY{k}{for} \PY{n}{chunk} \PY{o+ow}{in} \PY{n}{conjunto\PYZus{}de\PYZus{}datos}\PY{p}{:}
        \PY{n}{grouped} \PY{o}{=} \PY{n}{chunk}\PY{o}{.}\PY{n}{groupby}\PY{p}{(}\PY{n}{agrupando\PYZus{}chunk}\PY{p}{)}
        \PY{k}{for} \PY{n}{nombre\PYZus{}grupo}\PY{p}{,} \PY{n}{grupo} \PY{o+ow}{in} \PY{n}{grouped}\PY{p}{:}
            \PY{k}{if} \PY{n}{nombre\PYZus{}grupo} \PY{o+ow}{in} \PY{n}{grupos\PYZus{}acumulados}\PY{p}{:}
                \PY{n}{grupos\PYZus{}acumulados}\PY{p}{[}\PY{n}{nombre\PYZus{}grupo}\PY{p}{]} \PY{o}{=} \PY{n}{pd}\PY{o}{.}\PY{n}{concat}\PY{p}{(}
                    \PY{p}{[}\PY{n}{grupos\PYZus{}acumulados}\PY{p}{[}\PY{n}{nombre\PYZus{}grupo}\PY{p}{]}\PY{p}{,} \PY{n}{grupo}\PY{p}{]}
    ...
    \PY{c+c1}{\PYZsh{} Guardar cada grupo acumulado en archivos CSV separados}
    \PY{k}{for} \PY{n}{nombre\PYZus{}grupo}\PY{p}{,} \PY{n}{grupo} \PY{o+ow}{in} \PY{n}{grupos\PYZus{}acumulados}\PY{o}{.}\PY{n}{items}\PY{p}{(}\PY{p}{)}\PY{p}{:}
        \PY{c+c1}{\PYZsh{} se puede modificar el nombre del grupo con las dos lineas de codigo comentadas}
        \PY{c+c1}{\PYZsh{} y realizando un par de modificaciones}
        \PY{c+c1}{\PYZsh{} i = np.where(np.array(list(variables\PYZus{}contaminacion.values())) == nombre\PYZus{}grupo)[0]}
        \PY{c+c1}{\PYZsh{} name\PYZus{}archivo = np.array(list(variables\PYZus{}contaminacion.keys()))[i]}
        \PY{n}{nombre\PYZus{}archivo} \PY{o}{=} \PY{l+s+sa}{f}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+si}{\PYZob{}}\PY{n}{nombre\PYZus{}grupo}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s2}{.csv}\PY{l+s+s2}{\PYZdq{}}
        \PY{n}{grupo}\PY{o}{.}\PY{n}{to\PYZus{}csv}\PY{p}{(}\PY{n}{directorio\PYZus{}save} \PY{o}{+} \PY{n}{nombre\PYZus{}archivo}\PY{p}{,} \PY{n}{index}\PY{o}{=}\PY{k+kc}{False}\PY{p}{)}
        \PY{n+nb}{print}\PY{p}{(}\PY{l+s+sa}{f}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Guardado: }\PY{l+s+si}{\PYZob{}}\PY{n}{nombre\PYZus{}archivo}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}


\PY{k}{def} \PY{n+nf}{umbral\PYZus{}iqr}\PY{p}{(}\PY{n}{dataframe}\PY{p}{,} \PY{n}{variable}\PY{p}{)}\PY{p}{:}
\PY{+w}{    }\PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
\PY{l+s+sd}{    Esta función filtra los datos hubicado dentro de los bigotes del boxplot, eliminando}
\PY{l+s+sd}{    los valores atípicos que se encuentran fuera del rango delimitado}
\PY{l+s+sd}{    por los bigotes inferior y superior}

\PY{l+s+sd}{    dataframe: este parametro recibe un dataframe.}
\PY{l+s+sd}{    variable: columna especifica de datos del dataframe}

\PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}

    \PY{n}{Q1} \PY{o}{=} \PY{n}{dataframe}\PY{p}{[}\PY{n}{variable}\PY{p}{]}\PY{o}{.}\PY{n}{quantile}\PY{p}{(}\PY{l+m+mf}{0.25}\PY{p}{)}
    \PY{n}{Q3} \PY{o}{=} \PY{n}{dataframe}\PY{p}{[}\PY{n}{variable}\PY{p}{]}\PY{o}{.}\PY{n}{quantile}\PY{p}{(}\PY{l+m+mf}{0.75}\PY{p}{)}
    \PY{n}{iqr} \PY{o}{=} \PY{n}{Q3} \PY{o}{\PYZhy{}} \PY{n}{Q1}
    \PY{n}{lower\PYZus{}limit} \PY{o}{=} \PY{n}{Q1} \PY{o}{\PYZhy{}} \PY{l+m+mf}{1.5} \PY{o}{*} \PY{n}{iqr}
    \PY{n}{upper\PYZus{}limit} \PY{o}{=} \PY{n}{Q3} \PY{o}{+} \PY{l+m+mf}{1.5} \PY{o}{*} \PY{n}{iqr}

    \PY{k}{return} \PY{n}{lower\PYZus{}limit}\PY{p}{,} \PY{n}{upper\PYZus{}limit}


\PY{k}{def} \PY{n+nf}{covertir\PYZus{}formato\PYZus{}24\PYZus{}horas}\PY{p}{(}\PY{n}{fecha\PYZus{}12\PYZus{}horas}\PY{p}{)}\PY{p}{:}
\PY{+w}{    }\PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
\PY{l+s+sd}{    esta función convierte los datos de fecha que están en}
\PY{l+s+sd}{    formato 12 horas  a fechas en formato 24 horas}

\PY{l+s+sd}{    fecha\PYZus{}12\PYZus{}horas: este parámetro recibe una lista de fechas}
\PY{l+s+sd}{    en formato 12 horas}
\PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
    \PY{c+c1}{\PYZsh{} Convertir la fecha y hora de 12 horas a formato de 24 horas}
    \PY{n}{fecha\PYZus{}en\PYZus{}formato\PYZus{}24\PYZus{}horas} \PY{o}{=} \PY{p}{[}\PY{p}{]}
    \PY{k}{for} \PY{n}{formatear\PYZus{}fecha} \PY{o+ow}{in} \PY{n}{fecha\PYZus{}12\PYZus{}horas}\PY{p}{:}
        \PY{n}{fecha\PYZus{}24\PYZus{}horas} \PY{o}{=} \PY{n}{datetime}\PY{o}{.}\PY{n}{strptime}\PY{p}{(}\PY{n}{formatear\PYZus{}fecha}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+si}{\PYZpc{}d}\PY{l+s+s2}{/}\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{m/}\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{Y }\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{I:}\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{M:}\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{S }\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{p}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
        \PY{n}{fecha\PYZus{}en\PYZus{}formato\PYZus{}24\PYZus{}horas}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{fecha\PYZus{}24\PYZus{}horas}\PY{p}{)}
    \PY{n}{fecha\PYZus{}hora\PYZus{}con\PYZus{}formato} \PY{o}{=} \PY{p}{[}
        \PY{n}{darformato}\PY{o}{.}\PY{n}{strftime}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+si}{\PYZpc{}d}\PY{l+s+s2}{/}\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{m/}\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{Y }\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{H:}\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{M:}\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{S}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
        \PY{k}{for} \PY{n}{darformato} \PY{o+ow}{in} \PY{n}{fecha\PYZus{}en\PYZus{}formato\PYZus{}24\PYZus{}horas}
    \PY{p}{]}

    \PY{k}{return} \PY{n}{fecha\PYZus{}hora\PYZus{}con\PYZus{}formato}


\PY{k}{def} \PY{n+nf}{fechas\PYZus{}en\PYZus{}horas}\PY{p}{(}\PY{n}{lista\PYZus{}fechas\PYZus{}horas}\PY{p}{,} \PY{n}{fecha\PYZus{}referencia}\PY{o}{=}\PY{n}{datetime}\PY{p}{(}\PY{l+m+mi}{1970}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{)}\PY{p}{)}\PY{p}{:}
\PY{+w}{    }\PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
\PY{l+s+sd}{    Esta funcion recibe datos de fechas en formato  \PYZdq{}\PYZpc{}d/\PYZpc{}m/\PYZpc{}Y \PYZpc{}H:\PYZpc{}M:\PYZpc{}S\PYZdq{} y las convierte}
\PY{l+s+sd}{    a horas.}

\PY{l+s+sd}{    lista\PYZus{}fechas\PYZus{}horas: parametro que recibe una lista de fechas en formato \PYZdq{}\PYZpc{}d/\PYZpc{}m/\PYZpc{}Y \PYZpc{}H:\PYZpc{}M:\PYZpc{}S\PYZdq{}}
\PY{l+s+sd}{    fecha\PYZus{}referencia: parametro que recibe una fecha de referencia, por defecto es}
\PY{l+s+sd}{    1970, 1, 1, 0, 0, 0}

\PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}

    \PY{n}{horas} \PY{o}{=} \PY{p}{[}\PY{p}{]}
    \PY{k}{for} \PY{n}{fecha\PYZus{}hora} \PY{o+ow}{in} \PY{n}{lista\PYZus{}fechas\PYZus{}horas}\PY{p}{:}
        \PY{c+c1}{\PYZsh{} Convertir la fecha y hora a datetime}
        \PY{n}{fecha\PYZus{}hora\PYZus{}dt} \PY{o}{=} \PY{n}{datetime}\PY{o}{.}\PY{n}{strptime}\PY{p}{(}\PY{n}{fecha\PYZus{}hora}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+si}{\PYZpc{}d}\PY{l+s+s2}{/}\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{m/}\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{Y }\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{H:}\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{M:}\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{S}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
        \PY{c+c1}{\PYZsh{} Calcular la diferencia en horas respecto a la fecha de referencia}
        \PY{n}{diferencia} \PY{o}{=} \PY{p}{(}\PY{n}{fecha\PYZus{}hora\PYZus{}dt} \PY{o}{\PYZhy{}} \PY{n}{fecha\PYZus{}referencia}\PY{p}{)}\PY{o}{.}\PY{n}{total\PYZus{}seconds}\PY{p}{(}\PY{p}{)} \PY{o}{/} \PY{l+m+mi}{3600}
        \PY{n}{horas}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{diferencia}\PY{p}{)}
    \PY{k}{return} \PY{n}{horas}


\PY{k}{def} \PY{n+nf}{corr\PYZus{}pearsonr0}\PY{p}{(}\PY{n}{sizeclas}\PY{p}{)}\PY{p}{:}
    \PY{n}{array\PYZus{}corr\PYZus{}perason} \PY{o}{=} \PY{p}{[}\PY{p}{]}
    \PY{n}{array\PYZus{}corr\PYZus{}pevalue} \PY{o}{=} \PY{p}{[}\PY{p}{]}
    \PY{k}{for} \PY{n}{xi} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{sizeclas}\PY{p}{[}\PY{p}{:}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}\PY{p}{)}\PY{p}{:}
        \PY{n}{corr\PYZus{}perason} \PY{o}{=} \PY{p}{[}\PY{p}{]}
        \PY{n}{pvalue\PYZus{}perason} \PY{o}{=} \PY{p}{[}\PY{p}{]}
        \PY{k}{for} \PY{n}{yi} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{sizeclas}\PY{p}{[}\PY{p}{:}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}\PY{p}{)}\PY{p}{:}
            \PY{n}{varcorrpearson} \PY{o}{=} \PY{n}{stats}\PY{o}{.}\PY{n}{pearsonr}\PY{p}{(}\PY{n}{sizeclas}\PY{p}{[}\PY{n}{xi}\PY{p}{,} \PY{p}{:}\PY{p}{]}\PY{p}{,} \PY{n}{sizeclas}\PY{p}{[}\PY{n}{yi}\PY{p}{,} \PY{p}{:}\PY{p}{]}\PY{p}{)}
            \PY{n}{corr\PYZus{}perason}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{varcorrpearson}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}
            \PY{n}{pvalue\PYZus{}perason}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{varcorrpearson}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)}
            \PY{c+c1}{\PYZsh{} Jensen\PYZus{}Shannon\PYZus{}divergence(sizeclas[xi,:], sizeclas[yi,:]))  \PYZsh{}}
        \PY{n}{array\PYZus{}corr\PYZus{}perason}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{corr\PYZus{}perason}\PY{p}{)}
        \PY{n}{array\PYZus{}corr\PYZus{}pevalue}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{pvalue\PYZus{}perason}\PY{p}{)}
    \PY{n}{array\PYZus{}corr\PYZus{}perason} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{n}{array\PYZus{}corr\PYZus{}perason}\PY{p}{)}
    \PY{n}{array\PYZus{}corr\PYZus{}pevalue} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{n}{array\PYZus{}corr\PYZus{}pevalue}\PY{p}{)}
    \PY{k}{return} \PY{n}{array\PYZus{}corr\PYZus{}perason}\PY{p}{,} \PY{n}{array\PYZus{}corr\PYZus{}pevalue}


\PY{k}{def} \PY{n+nf}{plot\PYZus{}corr\PYZus{}pearsonr}\PY{p}{(}
    \PY{n}{harvest}\PY{p}{,}
    \PY{n}{titulos}\PY{p}{,}
    \PY{n}{farmers}\PY{p}{,}
    \PY{n}{figsize}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{30}\PY{p}{,} \PY{l+m+mi}{25}\PY{p}{)}\PY{p}{,}
    \PY{n}{labelsize}\PY{o}{=}\PY{l+m+mi}{10}\PY{p}{,}
    \PY{n}{fontsize}\PY{o}{=}\PY{l+m+mi}{10}\PY{p}{,}
    \PY{n}{fontz}\PY{o}{=}\PY{l+m+mi}{10}\PY{p}{,}
    \PY{n}{tight\PYZus{}layout}\PY{o}{=}\PY{k+kc}{True}\PY{p}{,}
    \PY{n}{pad}\PY{o}{=}\PY{l+m+mi}{20}\PY{p}{,}
\PY{p}{)}\PY{p}{:}
    \PY{n}{fig} \PY{o}{=} \PY{n}{plt}\PY{o}{.}\PY{n}{figure}\PY{p}{(}\PY{n}{figsize}\PY{o}{=}\PY{n}{figsize}\PY{p}{,} \PY{n}{tight\PYZus{}layout}\PY{o}{=}\PY{n}{tight\PYZus{}layout}\PY{p}{)}
    \PY{n}{gs} \PY{o}{=} \PY{n}{gridspec}\PY{o}{.}\PY{n}{GridSpec}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{)}
    ...
    \PY{n}{Color} \PY{o}{=} \PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{black}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{white}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}
    \PY{k}{for} \PY{n}{ut}\PY{p}{,} \PY{n}{ax} \PY{o+ow}{in} \PY{n+nb}{enumerate}\PY{p}{(}\PY{n}{ax}\PY{p}{)}\PY{p}{:}
        \PY{n}{pc} \PY{o}{=} \PY{n}{ax}\PY{o}{.}\PY{n}{imshow}\PY{p}{(}\PY{n}{harvest}\PY{p}{[}\PY{n}{ut}\PY{p}{]}\PY{p}{)}

        \PY{c+c1}{\PYZsh{} Show all ticks and label them with the respective list entries}
        \PY{n}{ax}\PY{o}{.}\PY{n}{set\PYZus{}xticks}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{arange}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{farmers}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}\PY{p}{)}\PY{p}{,} \PY{n}{labels}\PY{o}{=}\PY{n}{farmers}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}
        \PY{n}{ax}\PY{o}{.}\PY{n}{set\PYZus{}yticks}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{arange}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{farmers}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)}\PY{p}{)}\PY{p}{,} \PY{n}{labels}\PY{o}{=}\PY{n}{farmers}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)}
        ...
        \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{farmers}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}\PY{p}{)}\PY{p}{:}
            \PY{k}{for} \PY{n}{j} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{farmers}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)}\PY{p}{)}\PY{p}{:}
                \PY{n}{text} \PY{o}{=} \PY{n}{ax}\PY{o}{.}\PY{n}{text}\PY{p}{(}
                    \PY{n}{j}\PY{p}{,}
                    \PY{n}{i}\PY{p}{,}
                    \PY{n+nb}{round}\PY{p}{(}\PY{n}{harvest}\PY{p}{[}\PY{n}{ut}\PY{p}{]}\PY{p}{[}\PY{n}{i}\PY{p}{,} \PY{n}{j}\PY{p}{]}\PY{p}{,} \PY{l+m+mi}{3}\PY{p}{)}\PY{p}{,}
                    ...
                    \PY{n}{fontsize}\PY{o}{=}\PY{n}{fontz}\PY{p}{,}
                    \PY{n}{color}\PY{o}{=}\PY{n}{Color}\PY{p}{[}\PY{n}{ut}\PY{p}{]}\PY{p}{,}
                \PY{p}{)}

        \PY{n}{ax}\PY{o}{.}\PY{n}{set\PYZus{}title}\PY{p}{(}\PY{n}{titulos}\PY{p}{[}\PY{n}{ut}\PY{p}{]}\PY{p}{,} \PY{n}{fontsize}\PY{o}{=}\PY{n}{fontsize}\PY{p}{,} \PY{n}{pad}\PY{o}{=}\PY{n}{pad}\PY{p}{)}
        \PY{n}{ax}\PY{o}{.}\PY{n}{tick\PYZus{}params}\PY{p}{(}\PY{n}{labelsize}\PY{o}{=}\PY{n}{labelsize}\PY{p}{)}
        \PY{n}{ax}\PY{o}{.}\PY{n}{tick\PYZus{}params}\PY{p}{(}\PY{n}{labelsize}\PY{o}{=}\PY{n}{labelsize}\PY{p}{)}
    \PY{n}{fig}\PY{o}{.}\PY{n}{tight\PYZus{}layout}\PY{p}{(}\PY{p}{)}
    \PY{n}{fig}\PY{o}{.}\PY{n}{savefig}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{cvclima.pdf}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
    \PY{k}{return} \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}


\PY{k}{def} \PY{n+nf}{corr\PYZus{}pearsonr}\PY{p}{(}\PY{n}{sizeclas}\PY{p}{)}\PY{p}{:}
    \PY{n}{array\PYZus{}corr\PYZus{}perason} \PY{o}{=} \PY{p}{[}\PY{p}{]}
    \PY{n}{array\PYZus{}corr\PYZus{}pevalue} \PY{o}{=} \PY{p}{[}\PY{p}{]}
    \PY{k}{for} \PY{n}{xi} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{sizeclas}\PY{p}{[}\PY{p}{:}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}\PY{p}{)}\PY{p}{:}
        \PY{n}{corr\PYZus{}perason} \PY{o}{=} \PY{p}{[}\PY{p}{]}
...
\PY{k}{def} \PY{n+nf}{plt\PYZus{}corr\PYZus{}pears}\PY{p}{(}
    \PY{n}{harvest}\PY{p}{,}
    \PY{n}{titulos}\PY{p}{,}
    \PY{n}{farmers}\PY{p}{,}
    \PY{n}{figsize}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{30}\PY{p}{,} \PY{l+m+mi}{25}\PY{p}{)}\PY{p}{,}
    ...
    \PY{n}{fontsize}\PY{o}{=}\PY{l+m+mi}{10}\PY{p}{,}
    \PY{n}{tight\PYZus{}layout}\PY{o}{=}\PY{k+kc}{True}\PY{p}{,}
    \PY{n}{padd}\PY{o}{=}\PY{l+m+mi}{20}\PY{p}{,}
    \PY{n}{formato}\PY{o}{=}\PY{l+s+sa}{r}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{\PYZdl{}}\PY{l+s+si}{\PYZob{}:.2f\PYZcb{}}\PY{l+s+s2}{\PYZdl{}}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,}
    \PY{n}{descript}\PY{o}{=}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Descripción}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Descripción}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{,}
    \PY{n}{nNums}\PY{o}{=}\PY{l+m+mi}{10}\PY{p}{,}
    \PY{n}{size}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{4}\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,}
    \PY{n}{padr}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{15}\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,}
    \PY{n}{descrip\PYZus{}bar}\PY{o}{=}\PY{l+m+mi}{20}\PY{p}{,}
    \PY{n}{var\PYZus{}clima}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{varclima}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,}
    \PY{n}{wspace}\PY{o}{=}\PY{l+m+mf}{1.5}\PY{p}{,}
\PY{p}{)}\PY{p}{:}
    \PY{n}{fig} \PY{o}{=} \PY{n}{plt}\PY{o}{.}\PY{n}{figure}\PY{p}{(}\PY{n}{figsize}\PY{o}{=}\PY{n}{figsize}\PY{p}{,} \PY{n}{tight\PYZus{}layout}\PY{o}{=}\PY{n}{tight\PYZus{}layout}\PY{p}{)}
    \PY{n}{xmicol1} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{viridis}\PY{l+s+s2}{\PYZdq{}}
    \PY{n}{xcmap} \PY{o}{=} \PY{n}{mpl}\PY{o}{.}\PY{n}{colormaps}\PY{p}{[}\PY{n}{xmicol1}\PY{p}{]}\PY{o}{.}\PY{n}{resampled}\PY{p}{(}\PY{l+m+mi}{250}\PY{p}{)}
    \PY{n}{xnewcolors} \PY{o}{=} \PY{n}{xcmap}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{linspace}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{250}\PY{p}{)}\PY{p}{)}
    \PY{n}{cmap} \PY{o}{=} \PY{n}{ListedColormap}\PY{p}{(}\PY{n}{xnewcolors}\PY{p}{)}
    \PY{n}{gs} \PY{o}{=} \PY{n}{gridspec}\PY{o}{.}\PY{n}{GridSpec}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{)}
    \PY{n}{ax0} \PY{o}{=} \PY{n}{fig}\PY{o}{.}\PY{n}{add\PYZus{}subplot}\PY{p}{(}\PY{n}{gs}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}
    \PY{n}{ax1} \PY{o}{=} \PY{n}{fig}\PY{o}{.}\PY{n}{add\PYZus{}subplot}\PY{p}{(}\PY{n}{gs}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)}
    \PY{n}{ax} \PY{o}{=} \PY{p}{[}\PY{n}{ax0}\PY{p}{,} \PY{n}{ax1}\PY{p}{]}
    \PY{k}{for} \PY{n}{ut}\PY{p}{,} \PY{n}{ax} \PY{o+ow}{in} \PY{n+nb}{enumerate}\PY{p}{(}\PY{n}{ax}\PY{p}{)}\PY{p}{:}
        ...
        \PY{c+c1}{\PYZsh{} Rotate the tick labels and set their alignment.}
        \PY{n}{plt}\PY{o}{.}\PY{n}{setp}\PY{p}{(}\PY{n}{ax}\PY{o}{.}\PY{n}{get\PYZus{}xticklabels}\PY{p}{(}\PY{p}{)}\PY{p}{,} \PY{n}{rotation}\PY{o}{=}\PY{l+m+mi}{45}\PY{p}{,} \PY{n}{ha}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{right}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{rotation\PYZus{}mode}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{anchor}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
        \PY{n}{ax}\PY{o}{.}\PY{n}{set\PYZus{}title}\PY{p}{(}\PY{n}{titulos}\PY{p}{[}\PY{n}{ut}\PY{p}{]}\PY{p}{,} \PY{n}{fontsize}\PY{o}{=}\PY{n}{fontsize}\PY{p}{,} \PY{n}{pad}\PY{o}{=}\PY{n}{padd}\PY{p}{)}
        \PY{n}{ax}\PY{o}{.}\PY{n}{tick\PYZus{}params}\PY{p}{(}\PY{n}{labelsize}\PY{o}{=}\PY{n}{labelsize}\PY{p}{)}
        \PY{n}{ax}\PY{o}{.}\PY{n}{tick\PYZus{}params}\PY{p}{(}\PY{n}{labelsize}\PY{o}{=}\PY{n}{labelsize}\PY{p}{)}

        \PY{n}{ticks\PYZus{}loc} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{linspace}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{min}\PY{p}{(}\PY{n}{harvest}\PY{p}{[}\PY{n}{ut}\PY{p}{]}\PY{p}{)}\PY{p}{,} \PY{n}{np}\PY{o}{.}\PY{n}{max}\PY{p}{(}\PY{n}{harvest}\PY{p}{[}\PY{n}{ut}\PY{p}{]}\PY{p}{)}\PY{p}{,} \PY{n}{nNums}\PY{p}{)}

        \PY{n}{norm} \PY{o}{=} \PY{n}{matplotlib}\PY{o}{.}\PY{n}{colors}\PY{o}{.}\PY{n}{Normalize}\PY{p}{(}
            \PY{n}{vmin}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{min}\PY{p}{(}\PY{n}{harvest}\PY{p}{[}\PY{n}{ut}\PY{p}{]}\PY{p}{)}\PY{p}{,} \PY{n}{vmax}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{max}\PY{p}{(}\PY{n}{harvest}\PY{p}{[}\PY{n}{ut}\PY{p}{]}\PY{p}{)}
        \PY{p}{)}
        \PY{n}{sm} \PY{o}{=} \PY{n}{matplotlib}\PY{o}{.}\PY{n}{cm}\PY{o}{.}\PY{n}{ScalarMappable}\PY{p}{(}\PY{n}{cmap}\PY{o}{=}\PY{n}{cmap}\PY{p}{,} \PY{n}{norm}\PY{o}{=}\PY{n}{norm}\PY{p}{)}
        \PY{n}{ax2\PYZus{}divider} \PY{o}{=} \PY{n}{make\PYZus{}axes\PYZus{}locatable}\PY{p}{(}\PY{n}{ax}\PY{p}{)}
        \PY{n}{cax0} \PY{o}{=} \PY{n}{ax2\PYZus{}divider}\PY{o}{.}\PY{n}{append\PYZus{}axes}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{right}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{size}\PY{o}{=}\PY{n}{size}\PY{p}{,} \PY{n}{pad}\PY{o}{=}\PY{n}{padr}\PY{p}{)}
        \PY{n}{cbar0} \PY{o}{=} \PY{n}{fig}\PY{o}{.}\PY{n}{colorbar}\PY{p}{(}\PY{n}{pc}\PY{p}{,} \PY{n}{extend}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{both}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{cax}\PY{o}{=}\PY{n}{cax0}\PY{p}{,} \PY{n}{orientation}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{vertical}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
        \PY{n}{cbar0}\PY{o}{.}\PY{n}{ax}\PY{o}{.}\PY{n}{set\PYZus{}ylabel}\PY{p}{(}\PY{n}{descript}\PY{p}{[}\PY{n}{ut}\PY{p}{]}\PY{p}{,} \PY{n}{fontsize}\PY{o}{=}\PY{n}{descrip\PYZus{}bar}\PY{p}{)}
        \PY{n}{cbar0}\PY{o}{.}\PY{n}{ax}\PY{o}{.}\PY{n}{yaxis}\PY{o}{.}\PY{n}{set\PYZus{}major\PYZus{}locator}\PY{p}{(}\PY{n}{mticker}\PY{o}{.}\PY{n}{FixedLocator}\PY{p}{(}\PY{n}{ticks\PYZus{}loc}\PY{p}{)}\PY{p}{)}
        \PY{n}{cbar0}\PY{o}{.}\PY{n}{ax}\PY{o}{.}\PY{n}{set\PYZus{}yticklabels}\PY{p}{(}
            \PY{p}{[}\PY{n}{formato}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{x}\PY{p}{)} \PY{k}{for} \PY{n}{x} \PY{o+ow}{in} \PY{n}{ticks\PYZus{}loc}\PY{p}{]}\PY{p}{,} \PY{n}{fontsize}\PY{o}{=}\PY{n}{descrip\PYZus{}bar} \PY{o}{*} \PY{l+m+mf}{0.8}
        \PY{p}{)}
    \PY{n}{fig}\PY{o}{.}\PY{n}{tight\PYZus{}layout}\PY{p}{(}\PY{p}{)}
    \PY{n}{plt}\PY{o}{.}\PY{n}{subplots\PYZus{}adjust}\PY{p}{(}\PY{n}{wspace}\PY{o}{=}\PY{n}{wspace}\PY{p}{)}
    \PY{n}{fig}\PY{o}{.}\PY{n}{savefig}\PY{p}{(}\PY{l+s+sa}{f}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{plots/}\PY{l+s+si}{\PYZob{}}\PY{n}{var\PYZus{}clima}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s2}{\PYZus{}corr.png}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{bbox\PYZus{}inches}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{tight}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
    \PY{k}{return} \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}


\PY{k}{def} \PY{n+nf}{model\PYZus{}fit}\PY{p}{(}\PY{n}{x}\PY{p}{,} \PY{n}{m}\PY{p}{,} \PY{n}{b}\PY{p}{)}\PY{p}{:}
    \PY{n}{f} \PY{o}{=} \PY{n}{b} \PY{o}{+} \PY{n}{x} \PY{o}{*} \PY{n}{m}
    \PY{k}{return} \PY{n}{f}


\PY{k}{def} \PY{n+nf}{plots\PYZus{}lineal\PYZus{}model}\PY{p}{(}
    \PY{n}{z}\PY{p}{,}
    \PY{n}{mx}\PY{p}{,}
    \PY{n}{n\PYZus{}var}\PY{o}{=}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{i}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{j}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{,}
    \PY{n}{titX}\PY{o}{=}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{x}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{x}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{,}
    \PY{n}{titY}\PY{o}{=}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{y}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{y}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{,}
    \PY{n}{limX}\PY{o}{=}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,}
    \PY{n}{limY}\PY{o}{=}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,}
    \PY{n}{ngr}\PY{o}{=}\PY{l+m+mi}{0}\PY{p}{,}
\PY{p}{)}\PY{p}{:}
    \PY{n}{fig}\PY{p}{,} \PY{n}{ax} \PY{o}{=} \PY{n}{plt}\PY{o}{.}\PY{n}{subplots}\PY{p}{(}\PY{n}{nrows}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{,} \PY{n}{ncols}\PY{o}{=}\PY{l+m+mi}{2}\PY{p}{,} \PY{n}{figsize}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{20}\PY{p}{,} \PY{l+m+mi}{8}\PY{p}{)}\PY{p}{)}
    \PY{k}{for} \PY{n}{u}\PY{p}{,} \PY{n}{array\PYZus{}freq} \PY{o+ow}{in} \PY{n+nb}{enumerate}\PY{p}{(}\PY{n}{mx}\PY{p}{)}\PY{p}{:}
        \PY{n}{enx} \PY{o}{=} \PY{p}{[}\PY{p}{]}
        \PY{n}{eny} \PY{o}{=} \PY{p}{[}\PY{p}{]}
        \PY{n}{nN} \PY{o}{=} \PY{n+nb}{len}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{n}{array\PYZus{}freq}\PY{p}{)}\PY{p}{[}\PY{p}{:}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}
        \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{nN}\PY{p}{)}\PY{p}{:}
            \PY{k}{for} \PY{n}{j} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{i} \PY{o}{+} \PY{l+m+mi}{1}\PY{p}{,} \PY{n}{nN}\PY{p}{)}\PY{p}{:}
                \PY{n}{ai} \PY{o}{=} \PY{n+nb}{list}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{n}{array\PYZus{}freq}\PY{p}{)}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{p}{)}
                \PY{n}{aj} \PY{o}{=} \PY{n+nb}{list}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{n}{array\PYZus{}freq}\PY{p}{)}\PY{p}{[}\PY{n}{j}\PY{p}{]}\PY{p}{)}
                \PY{n}{corr}\PY{p}{,} \PY{n}{\PYZus{}} \PY{o}{=} \PY{n}{pearsonr}\PY{p}{(}\PY{n}{ai}\PY{p}{,} \PY{n}{aj}\PY{p}{)}
                \PY{k}{if} \PY{n}{corr} \PY{o}{\PYZgt{}} \PY{l+m+mf}{0.7}\PY{p}{:}
                    \PY{n}{enx} \PY{o}{+}\PY{o}{=} \PY{n+nb}{list}\PY{p}{(}\PY{n}{ai}\PY{p}{)}
                    \PY{n}{eny} \PY{o}{+}\PY{o}{=} \PY{n+nb}{list}\PY{p}{(}\PY{n}{aj}\PY{p}{)}
                    \PY{n}{xi} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{n}{ai}\PY{p}{,} \PY{n}{dtype}\PY{o}{=}\PY{n+nb}{float}\PY{p}{)}
                    \PY{n}{yi} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{n}{aj}\PY{p}{,} \PY{n}{dtype}\PY{o}{=}\PY{n+nb}{float}\PY{p}{)}
                    \PY{n}{ax}\PY{p}{[}\PY{n}{u}\PY{p}{]}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{xi}\PY{p}{[}\PY{n}{xi} \PY{o}{\PYZlt{}} \PY{n}{z}\PY{p}{]}\PY{p}{,} \PY{n}{yi}\PY{p}{[}\PY{n}{xi} \PY{o}{\PYZlt{}} \PY{n}{z}\PY{p}{]}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{o}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{label}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Datos}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}

        \PY{n}{x} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{n}{enx}\PY{p}{,} \PY{n}{dtype}\PY{o}{=}\PY{n+nb}{float}\PY{p}{)}
        \PY{n}{y} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{n}{eny}\PY{p}{,} \PY{n}{dtype}\PY{o}{=}\PY{n+nb}{float}\PY{p}{)}
        \PY{n}{xx} \PY{o}{=} \PY{n}{x}\PY{p}{[}\PY{n}{x} \PY{o}{\PYZlt{}} \PY{n}{z}\PY{p}{]}
        \PY{n}{yy} \PY{o}{=} \PY{n}{y}\PY{p}{[}\PY{n}{x} \PY{o}{\PYZlt{}} \PY{n}{z}\PY{p}{]}
        \PY{n}{chi2} \PY{o}{=} \PY{n}{Chi2Regression}\PY{p}{(}\PY{n}{model\PYZus{}fit}\PY{p}{,} \PY{n}{xx}\PY{p}{,} \PY{n}{yy}\PY{p}{)}
        \PY{n}{p} \PY{o}{=} \PY{n}{Minuit}\PY{p}{(}\PY{n}{chi2}\PY{p}{,} \PY{n}{m}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{,} \PY{n}{b}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{)}
        \PY{n}{p}\PY{o}{.}\PY{n}{migrad}\PY{p}{(}\PY{p}{)}

        \PY{n}{m\PYZus{}fit} \PY{o}{=} \PY{n}{p}\PY{o}{.}\PY{n}{values}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{m}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}
        \PY{n}{b\PYZus{}fit} \PY{o}{=} \PY{n}{p}\PY{o}{.}\PY{n}{values}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{b}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}
        \PY{n+nb}{print}\PY{p}{(}\PY{l+s+sa}{f}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Parámetros ajustados: a=}\PY{l+s+si}{\PYZob{}}\PY{n}{m\PYZus{}fit}\PY{l+s+si}{:}\PY{l+s+s2}{.2f}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s2}{, b=}\PY{l+s+si}{\PYZob{}}\PY{n}{b\PYZus{}fit}\PY{l+s+si}{:}\PY{l+s+s2}{.2f}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
        \PY{n}{ax}\PY{p}{[}\PY{n}{u}\PY{p}{]}\PY{o}{.}\PY{n}{plot}\PY{p}{(}
            \PY{n}{xx}\PY{p}{,}
            \PY{n}{model\PYZus{}fit}\PY{p}{(}\PY{n}{xx}\PY{p}{,} \PY{n}{m\PYZus{}fit}\PY{p}{,} \PY{n}{b\PYZus{}fit}\PY{p}{)}\PY{p}{,}
            \PY{n}{color}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{black}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,}
            \PY{n}{label}\PY{o}{=}\PY{l+s+sa}{f}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Ajuste: a=}\PY{l+s+si}{\PYZob{}}\PY{n}{m\PYZus{}fit}\PY{l+s+si}{:}\PY{l+s+s2}{.2f}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s2}{, b=}\PY{l+s+si}{\PYZob{}}\PY{n}{b\PYZus{}fit}\PY{l+s+si}{:}\PY{l+s+s2}{.2f}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,}
        \PY{p}{)}

        \PY{n}{ax}\PY{p}{[}\PY{n}{u}\PY{p}{]}\PY{o}{.}\PY{n}{set\PYZus{}xlabel}\PY{p}{(}\PY{l+s+sa}{f}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+si}{\PYZob{}}\PY{n}{titX}\PY{p}{[}\PY{n}{u}\PY{p}{]}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{labelpad}\PY{o}{=}\PY{l+m+mi}{20}\PY{p}{,} \PY{n}{fontsize}\PY{o}{=}\PY{l+m+mi}{30}\PY{p}{)}
        \PY{n}{ax}\PY{p}{[}\PY{n}{u}\PY{p}{]}\PY{o}{.}\PY{n}{set\PYZus{}ylabel}\PY{p}{(}\PY{l+s+sa}{f}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+si}{\PYZob{}}\PY{n}{titY}\PY{p}{[}\PY{n}{u}\PY{p}{]}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{labelpad}\PY{o}{=}\PY{l+m+mi}{20}\PY{p}{,} \PY{n}{fontsize}\PY{o}{=}\PY{l+m+mi}{30}\PY{p}{)}
        \PY{n}{ax}\PY{p}{[}\PY{n}{u}\PY{p}{]}\PY{o}{.}\PY{n}{set\PYZus{}title}\PY{p}{(}\PY{l+s+sa}{f}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+si}{\PYZob{}}\PY{n}{n\PYZus{}var}\PY{p}{[}\PY{n}{u}\PY{p}{]}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{pad}\PY{o}{=}\PY{l+m+mi}{25}\PY{p}{,} \PY{n}{fontsize}\PY{o}{=}\PY{l+m+mi}{30}\PY{p}{)}
        \PY{n}{ax}\PY{p}{[}\PY{n}{u}\PY{p}{]}\PY{o}{.}\PY{n}{tick\PYZus{}params}\PY{p}{(}\PY{n}{labelsize}\PY{o}{=}\PY{l+m+mi}{30} \PY{o}{*} \PY{l+m+mf}{0.9}\PY{p}{)}
        \PY{n}{ax}\PY{p}{[}\PY{n}{u}\PY{p}{]}\PY{o}{.}\PY{n}{tick\PYZus{}params}\PY{p}{(}\PY{n}{labelsize}\PY{o}{=}\PY{l+m+mi}{30} \PY{o}{*} \PY{l+m+mf}{0.9}\PY{p}{)}
        \PY{n}{ax}\PY{p}{[}\PY{n}{u}\PY{p}{]}\PY{o}{.}\PY{n}{set\PYZus{}xlim}\PY{p}{(}\PY{o}{\PYZhy{}}\PY{l+m+mf}{0.005}\PY{p}{,} \PY{n}{limX}\PY{p}{[}\PY{n}{u}\PY{p}{]}\PY{p}{)}
        \PY{n}{ax}\PY{p}{[}\PY{n}{u}\PY{p}{]}\PY{o}{.}\PY{n}{set\PYZus{}ylim}\PY{p}{(}\PY{o}{\PYZhy{}}\PY{l+m+mf}{0.005}\PY{p}{,} \PY{n}{limY}\PY{p}{[}\PY{n}{u}\PY{p}{]}\PY{p}{)}
        \PY{c+c1}{\PYZsh{} ax[u].legend(fontsize=15)}
    \PY{n}{fig}\PY{o}{.}\PY{n}{tight\PYZus{}layout}\PY{p}{(}\PY{p}{)}
    \PY{n}{plt}\PY{o}{.}\PY{n}{subplots\PYZus{}adjust}\PY{p}{(}\PY{n}{wspace}\PY{o}{=}\PY{l+m+mf}{0.3}\PY{p}{)}
    \PY{n}{fig}\PY{o}{.}\PY{n}{savefig}\PY{p}{(}\PY{l+s+sa}{f}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{plots/gxGraf}\PY{l+s+si}{\PYZob{}}\PY{n}{ngr}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s2}{.png}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{bbox\PYZus{}inches}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{tight}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
    \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}


\PY{k}{def} \PY{n+nf}{param\PYZus{}lineal\PYZus{}model}\PY{p}{(}\PY{n}{z}\PY{p}{,} \PY{n}{array\PYZus{}freq}\PY{p}{,} \PY{n}{xmunic}\PY{p}{)}\PY{p}{:}
    \PY{n}{enx} \PY{o}{=} \PY{p}{[}\PY{p}{]}
    \PY{n}{eny} \PY{o}{=} \PY{p}{[}\PY{p}{]}
    \PY{n}{valcorr} \PY{o}{=} \PY{p}{[}\PY{p}{]}
    \PY{n}{mun\PYZus{}val} \PY{o}{=} \PY{p}{[}\PY{p}{]}
    \PY{n}{nN} \PY{o}{=} \PY{n+nb}{len}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{n}{array\PYZus{}freq}\PY{p}{)}\PY{p}{[}\PY{p}{:}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}
    \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{nN}\PY{p}{)}\PY{p}{:}
        \PY{k}{for} \PY{n}{j} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{i} \PY{o}{+} \PY{l+m+mi}{1}\PY{p}{,} \PY{n}{nN}\PY{p}{)}\PY{p}{:}
            \PY{n}{ai} \PY{o}{=} \PY{n+nb}{list}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{n}{array\PYZus{}freq}\PY{p}{)}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{p}{)}
            ...
            \PY{n}{corr}\PY{p}{,} \PY{n}{\PYZus{}} \PY{o}{=} \PY{n}{pearsonr}\PY{p}{(}\PY{n}{ai}\PY{p}{,} \PY{n}{aj}\PY{p}{)}
            \PY{k}{if} \PY{n}{corr} \PY{o}{\PYZgt{}} \PY{l+m+mf}{0.7}\PY{p}{:}
                \PY{n}{valcorr}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{corr}\PY{p}{)}
                \PY{n}{mun\PYZus{}val}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{p}{[}\PY{n}{xmunic}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{p}{,} \PY{n}{xmunic}\PY{p}{[}\PY{n}{j}\PY{p}{]}\PY{p}{]}\PY{p}{)}
                \PY{n}{enx} \PY{o}{+}\PY{o}{=} \PY{n+nb}{list}\PY{p}{(}\PY{n}{ai}\PY{p}{)}
                \PY{n}{eny} \PY{o}{+}\PY{o}{=} \PY{n+nb}{list}\PY{p}{(}\PY{n}{aj}\PY{p}{)}
                \PY{n}{xi} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{n}{ai}\PY{p}{,} \PY{n}{dtype}\PY{o}{=}\PY{n+nb}{float}\PY{p}{)}
                \PY{n}{yi} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{n}{aj}\PY{p}{,} \PY{n}{dtype}\PY{o}{=}\PY{n+nb}{float}\PY{p}{)}
    ...
    \PY{n}{m\PYZus{}fit} \PY{o}{=} \PY{n+nb}{round}\PY{p}{(}\PY{n}{p}\PY{o}{.}\PY{n}{values}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{m}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{,} \PY{l+m+mi}{3}\PY{p}{)}
    \PY{n}{b\PYZus{}fit} \PY{o}{=} \PY{n+nb}{round}\PY{p}{(}\PY{n}{p}\PY{o}{.}\PY{n}{values}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{b}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{,} \PY{l+m+mi}{3}\PY{p}{)}
    \PY{k}{return} \PY{n}{m\PYZus{}fit}\PY{p}{,} \PY{n}{b\PYZus{}fit}\PY{p}{,} \PY{n}{mun\PYZus{}val}\PY{p}{,} \PY{n}{valcorr}
\end{Verbatim}
\end{tcolorbox}
...
[NbConvertApp] Support files will be in datosaire\_files/
[NbConvertApp] Writing 187400 bytes to datosaire.tex
    \end{Verbatim}
